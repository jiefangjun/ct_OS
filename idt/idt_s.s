...
isr_common_stub:
	...
	push esp 		; 此时 esp 寄存器的值等价于 pt_regs 结构体的指针
	...
	popa 			; Pops edi, esi, eb, esp, ebx, edx, ecx, eax
	add esp, 8		; 清除栈里的 error code 和 ISR
	iret
...
[EXTERN irq_handler]
irq_common_stub:
	pusha 		; pushes edi, esi, ebp, exp, ebx, edx, ecx, eax
